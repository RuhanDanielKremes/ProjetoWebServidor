<?php
    ...
    $DB = [
        'name' => ['admin', 'user1', 'user2', 'user3', 'user4', 'user5', 'user6', 'user7', 'user8', 'user9'],
        ...
        'password' => ['AdminPassword', 'User1Password', 'User2Password', 'User3Password', 'User4Password', 'User5Password', 'User6Password', 'User7Password', 'User8Password', 'User9Password'],
        ...
        'role' => ['admin', 'user', 'user', 'user', 'user', 'user', 'user', 'user', 'user', 'user'],
