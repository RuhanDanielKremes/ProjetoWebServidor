<?php
    ...
    $DB = [
        'name' => ['Ruhan', 'user1', 'user2', 'user3', 'user4', 'user5', 'user6', 'user7', 'user8', 'kaue'],
        ...
        'password' => ['1234', 'User1Password', 'User2Password', 'User3Password', 'User4Password', 'User5Password', 'User6Password', 'User7Password', 'User8Password', '4321'],
        ...
        'role' => ['admin', 'user', 'user', 'user', 'user', 'user', 'user', 'user', 'user', 'admin'],
